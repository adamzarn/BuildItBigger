...
class EndpointsAsyncTask extends AsyncTask<JokeReceivedListener, Void, String> {
    ...
    private JokeReceivedListener listener;
    ...
    protected String doInBackground(JokeReceivedListener... params) {
        if(myApiService == null) {  // Only do this once
            MyApi.Builder builder = new MyApi.Builder(AndroidHttp.newCompatibleTransport(),
                    ...
                    .setRootUrl("http://192.168.1.170:8080/_ah/api/")
        ...
        try {
            return myApiService.getJoke().execute().getSetupAndPunchline();
        } catch (IOException e) {
            return e.getMessage();
        }
    }
